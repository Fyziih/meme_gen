...
function showMeme() {
  ...
  const memeConatiner = document.querySelector('.meme-content');
  const memeName = document.createElement('img');
  memeName.setAttribute("src",randomMemeUrl);

clearAll();
  memeConatiner.appendChild(memeName);
}
...
function showJoke() {
  ...
  const jokeConatiner = document.querySelector('.joke-content');
  const jokeName = document.createElement('p');
  jokeName.textContent=randomJokeText;

clearAll();
  jokeConatiner.appendChild(jokeName);
}
...
function showQuote() {
  ...
  const quoteConatiner = document.querySelector('.quote-content');

  const quoteName = document.createElement('p'); 
  const authorName = document.createElement('p'); 

  quoteName.textContent=randomQuote.quote;
  authorName.textContent="- " + randomQuote.author;

clearAll();
  quoteConatiner.appendChild(quoteName);
  quoteConatiner.appendChild(authorName);
}
...
function showRiddle() {
  ...
  const qstnName = document.createElement('p'); 
  const answrName = document.createElement('p'); 

  qstnName.textContent=randomRiddle.question;
  answrName.textContent="ans: " + randomRiddle.answer;

clearAll();
  riddleConatiner.appendChild(qstnName);
  riddleConatiner.appendChild(answrName);
}
